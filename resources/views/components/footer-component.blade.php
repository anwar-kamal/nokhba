        ...
        <div class=" container">
                    ...
                    <div class="flex items-center py-5 md:py-0 md:items-start justify-center flex-col gap-2">
                        ...
                        <ul class="grid gap-1" >
                            @foreach ($navItem['children'] as $navItemChildren)
                                <li cl><a class="nav-link nav-link-ltr before:bottom-4  w-fit"
            ...
            <div class=" flex flex-col md:flex-row justify-between items-center  gap-4 py-8">
                ...
                <div class=" flex gap-4 ">
                    <img src="{{ asset('assets/img/tamara.png') }}" alt="tamara" class=" max-w-[50px] md:max-w-[75px]">
                    <img src="{{ asset('assets/img/tabby.png') }}" alt="tabby" class=" max-w-[50px] md:max-w-[75px]">
                    <img src="{{ asset('assets/img/master.png') }}" alt="master" class=" max-w-[50px] md:max-w-[75px]">
                    <img src="{{ asset('assets/img/mada.png') }}" alt="mada" class=" max-w-[50px] md:max-w-[75px]" />
                </div>
            </div>
        </div>
    </div>
